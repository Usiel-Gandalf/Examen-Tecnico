...
public interface MainContract {
    ...
    interface Model{
        void getInfoFB(FirebaseFirestore db, Context context, MainContract.Presenter listener, List<userinfo> listinfo);

        void getInfoFBForUser(String user, FirebaseFirestore db, Context context, MainContract.Presenter listener);

        void getInfoFBForCountry(String country, FirebaseFirestore db, Context context, MainContract.Presenter listener);

        void getInfoFBForState(String state, FirebaseFirestore db, Context context, MainContract.Presenter listener);

        void getInfoFBForGender(String gender, FirebaseFirestore db, Context context, MainContract.Presenter listener);
    }
}
