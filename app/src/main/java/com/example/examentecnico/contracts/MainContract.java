...
public interface MainContract {
    ...
    interface Model{
        void saveOrUpdateData(String usuario, String pais, String estado, String genero, Map<String, Object> map, FirebaseFirestore db, MainContract.Presenter listener);
